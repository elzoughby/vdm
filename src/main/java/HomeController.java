...
public class HomeController implements Initializable {
    ...
    private void addBtnAction() {
        ...
        try {
            ...
            controller.setQueueBtnSelected(queueBtn.isSelected());
    ...
    private void infoBtnAction() {
        ...
        if( selectedItem != null) {
            ...
            try {
                ...
                infoWindowController.closeUrlDialog();
                ...
                infoWindowController.getQualityTitledPane().setExpanded(true);
                infoWindowController.getQualityTitledPane().setCollapsible(false);
                ...
                infoWindowController.getVideoQualityChoiceBox().getItems().add(selectedItem.getVideoQuality());
                infoWindowController.getVideoQualityChoiceBox().setValue(selectedItem.getVideoQuality());
                infoWindowController.getVideoQualityChoiceBox().setDisable(true);
                infoWindowController.getAudioQualityChoiceBox().getItems().add(selectedItem.getAudioQuality());
                infoWindowController.getAudioQualityChoiceBox().setValue(selectedItem.getAudioQuality());
                infoWindowController.getAudioQualityChoiceBox().setDisable(true);
                infoWindowController.getFormatChoiceBox().getItems().add(selectedItem.getFormat());
                infoWindowController.getFormatChoiceBox().setValue(selectedItem.getFormat());
                infoWindowController.getFormatChoiceBox().setDisable(true);
                if(selectedItem.getNeedEmbeddedSubtitle() || selectedItem.getNeedAutoGeneratedSubtitle()) {
                    ...
                    infoWindowController.getScrollPaneVBox().getChildren().remove(infoWindowController.getWebsiteTitledPane());
                }
    ...
    public boolean deleteItemFiles(String path) {
