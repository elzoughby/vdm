...
public class Item {
    ...
    public void finishDownload() {
        ...
        if(isAddToQueue()) {
            Item nextQueueItem = getNextQueueItem();
            if(nextQueueItem != null && nextQueueItem.getStatus().equals("Stopped"))
    ...
    private Item getNextQueueItem() {

        int itemIndex = HomeController.getQueueItemList().indexOf(this);
